...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_SpriteRelativeSize_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_SpriteRelativeSize;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBSBirdDetector_Statics::NewProp_SpriteRelativeSize_MetaData[] = {
		{ "Category", "BSBirdDetector" },
		{ "ModuleRelativePath", "Public/BSBirdDetector.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBSBirdDetector_Statics::NewProp_SpriteRelativeSize = { "SpriteRelativeSize", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBSBirdDetector, SpriteRelativeSize), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UBSBirdDetector_Statics::NewProp_SpriteRelativeSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBSBirdDetector_Statics::NewProp_SpriteRelativeSize_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UBSBirdDetector_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBSBirdDetector_Statics::NewProp_SpriteRelativeSize,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DemoForest_Plugins_BirdDetector_Source_BirdDetector_Public_BSBirdDetector_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBSBirdDetector, UBSBirdDetector::StaticClass, TEXT("UBSBirdDetector"), &Z_Registration_Info_UClass_UBSBirdDetector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBSBirdDetector), 4068522825U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_DemoForest_Plugins_BirdDetector_Source_BirdDetector_Public_BSBirdDetector_h_3897339145(TEXT("/Script/BirdDetector"),
